        ...
        <>
            ...
            <div className={styles.presetContainer}>
                <VSCodeButton
                    ...
                    appearance="icon"
                    aria-label="Production Standard"
                ...
                <VSCodeButton
                    className={styles.preset}
                    appearance="icon"
                    aria-label="Production Economy"
                    onClick={() => handlePresetClick("economy")}
                >
                    <div>
                        <span>icon</span>
                ...
                <VSCodeButton
                    className={styles.preset}
                    appearance="icon"
                    aria-label="Production Enterprise"
                    onClick={() => handlePresetClick("enterprise")}
                >
                    <div>
                        <span>icon</span>
