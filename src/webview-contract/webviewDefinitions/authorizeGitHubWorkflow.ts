...
export type GitHubRepoSecret = "AZURE_CLIENT_ID" | "AZURE_TENANT_ID" | "AZURE_SUBSCRIPTION_ID";
...
export type ToVsCodeMsgDef = {
    ...
    deletePullRequestFederatedCredentialRequest: {
        key: EntraIdApplicationKey;
        repositoryKey: GitHubRepoKey;
    };
    deleteBranchFederatedCredentialRequest: {
        key: EntraIdApplicationKey;
        repositoryKey: GitHubRepoKey;
        branch: string;
    };
    ...
    deleteClusterRoleAssignmentRequest: {
        clusterKey: ClusterKey;
        servicePrincipalKey: ServicePrincipalKey;
        roleDefinitionKey: ClusterRoleDefinitionKey;
    };

    // Entra ID application CRUD
    createEntraIdApplicationRequest: {
        applicationName: string;
    };
    deleteEntraIdApplicationRequest: EntraIdApplicationKey;
};
...
export type ToWebViewMsgDef = {
    ...
    deletePullRequestFederatedCredentialResponse: {
        key: EntraIdApplicationKey;
        repositoryKey: GitHubRepoKey;
        hasCredential: boolean;
    };
    deleteBranchFederatedCredentialResponse: {
        key: EntraIdApplicationKey;
        repositoryKey: GitHubRepoKey;
        branch: string;
        hasCredential: boolean;
    ...
    deleteClusterRoleAssignmentResponse: {
        clusterKey: ClusterKey;
        servicePrincipalKey: ServicePrincipalKey;
        roleDefinitionKey: ClusterRoleDefinitionKey;
        assignedRoleDefinitions: ClusterRoleDefinition[];
    ...
    // Entra ID application CRUD responses
    ...
    deleteEntraIdApplicationResponse: {
        applications: EntraIdApplication[];
    };
};
